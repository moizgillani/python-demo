...
from servicingmerchantcasemanagementapi.configuration import Configuration
...
from servicingmerchantcasemanagementapi.http.auth.custom_header_authentication import CustomHeaderAuthentication
from servicingmerchantcasemanagementapi.controllers.case_controller\
    import CaseController
from servicingmerchantcasemanagementapi.controllers.lookup_controller\
    import LookupController


class ServicingmerchantcasemanagementapiClient(object):

    @LazyProperty
    def case(self):
        return CaseController(self.global_configuration)

    @LazyProperty
    def lookup(self):
        return LookupController(self.global_configuration)
