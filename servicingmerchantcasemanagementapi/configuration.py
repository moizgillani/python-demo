...
class Configuration(HttpClientConfiguration):
    ...
    def __init__(
        ...
        retry_methods=['GET', 'PUT', 'GET', 'PUT'], environment=Environment.PRODUCTION, authorization='TODO: Replace'
    ):
    ...
    environments = {
        Environment.PRODUCTION: {
            Server.DEFAULT: 'https://apis.cert.worldpay.com/merchant-servicing/casemanagement/v1'
        }
    }
